...
# Here I am making the catstronaut itself!
class Player(pygame.sprite.Sprite):
    ...
    # This just tells the bullet where to spawn
    def shoot(self):
        now = pygame.time.get_ticks()
        if now - self.last_shot > self.shoot_delay:
            ...
            if self.power >= 3:
                bullet1 = Bullet(self.rect.left, self.rect.centery)
                bullet2 = Bullet(self.rect.right, self.rect.centery)
                missile1 = Missile(self.rect.centerx, self.rect.top) # Missile shoots from center of the kitty
                all_sprites.add(bullet1)
                all_sprites.add(bullet2)
...
#Defines the asteroid enemys and stufff
...
class Pow(pygame.sprite.Sprite):
    ...
    def update(self):
        self.rect.y += self.speedy
        # Kills the sprite after it moves over the top border
        if self.rect.top > HEIGHT:
            self.kill()

            

# Some bullet and sprite interaction stuff
class Bullet(pygame.sprite.Sprite):
    ...
    def update(self):
        ...
        # I kinda prefer shooting with the spacebar, so I did that.
...
# Here I am loading all the game images
